...
<head>
 ...
 ============================== -->
    ...
    <link
        href="{{ asset('https://fonts.googleapis.com/css2?family=Kanit:wght@300;400;500;600;700;800&family=Kumbh+Sans:wght@300;400;500;600;700&display=swap') }}"
        rel="stylesheet">
 ...
 ============================== -->
    ...
    <style>
        ...
        html {
            ...
            margin: 0;
            color: white;
            background: linear-gradient(180deg, rgba(5, 19, 27, 0.9), rgba(30, 93, 129, 0.9));
            object-fit: cover;
        }
        ...
        main {
            ...
            width: 100%;
            background: transparent box-shadow: 0 0.5px 0 1px rgba(255, 255, 255, 0.23) inset,
                ...
                <ul>
                    <li style="padding-left: 7%;" class="nav-item active">
                        ...
                        <a href="/admin">
                            ...
                            <span class="nav-text">Perfil Admin </span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <a href="#">
                           ...
                           git <span class="nav-text">Atividades</span>
                        </a>
                    </li>

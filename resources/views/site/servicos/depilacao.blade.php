...
@section('title', 'Servico - Le Flower')
                ...
                <div class="row gy-5 justify-content-center">
                    <div class="col-md-6  order-xl-2 container1">
                        <div class="about-thumb-2">
                            <img style="border-radius: 20px;height:650px;width:730px;" class="about-img-1 img-fluid" src="{{ asset('assets/servicos/fotos-compri/depi1.png') }}" alt="img">
            ...
            <div class="container-fluid servico" style="display: flex;">
                <div class="row gy-5 justify-content-center">
                    <div class="col-md-6 container2">
                        <div class="about-thumb-2">
                            <img style="border-radius: 20px;height:650px;width:730px;" class="about-img-1 img-fluid" src="{{ asset('assets/servicos/fotos-compri/depi2.png') }}" alt="img">
                            <div class="about-thumb-num">
                    ...
                    <div class="col-md-6 ">
                        <div style="" class="card-menu2">
                            ...
                            <div class="card-body">
                                ...
                                <div class="service">
                                    <div class="d-flex justify-content-between">
                                        <h4 class="service-title" style="color: #202020;">Depilação com linha</h4>
                                        <h4 style="color: #202020;">R$ 269,99</h4>
                                    </div>
                                    <p class="service-description">Esta técnica envolve o uso de uma linha de algodão torcida para remover pelos indesejados. É comumente usado para moldar as sobrancelhas.</p>
                                  <p>..........................................................................................................................</p>
            ...
            <div class="container-fluid servico" style="display: flex;">
                <div class="row gy-5 justify-content-center">
                    <div class="col-md-6  order-xl-2 container3">
                        <div class="about-thumb-2">
                            <img style="border-radius: 20px;height:650px;width:730px" class="about-img-1 img-fluid" src="{{ asset('assets/servicos/fotos-compri/depi3.png') }}" alt="img">
                            <div class="about-thumb-num">
                                Depilações técnicas
                            </div>
                        </div>

                ...
                <div class="row gy-5 justify-content-center">
                    <div class="col-md-6  order-xl-2 container1">
                        <div class="about-thumb-2">
                            <img style="border-radius: 20px;height:750px;width:730px;" class="about-img-1 img-fluid" src="{{ asset('assets/servicos/fotos-compri/barba1.png') }}" alt="img">
            ...
            <div class="container-fluid servico" style="display: flex;">
                <div class="row gy-5 justify-content-center">
                    <div class="col-md-6 container2">
                        <div class="about-thumb-2">
                            <img style="border-radius: 20px;height:750px;width:730px;" class="about-img-1 img-fluid" src="{{ asset('assets/servicos/fotos-compri/barba2.png') }}" alt="img">
                            <div class="about-thumb-num">
            ...
            <div class="container-fluid servico" style="display: flex;">
                <div class="row gy-5 justify-content-center">
                    <div class="col-md-6  order-xl-2 container3">
                        <div class="about-thumb-2">
                            <img style="border-radius: 20px;height:750px;width:730px;" class="about-img-1 img-fluid" src="{{ asset('assets/servicos/fotos-compri/barba3.png') }}" alt="img">
                            <div class="about-thumb-num">
